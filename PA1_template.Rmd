...
## Setting up environment to get rid of messages in Danish
...
```
```{r, results='hide', echo=FALSE}
## Using ggplot2 later on - loading library
suppressPackageStartupMessages(library(ggplot2))
library(ggplot2)
## 3 seperate blocks of code since it does not seem to work with 1
```
